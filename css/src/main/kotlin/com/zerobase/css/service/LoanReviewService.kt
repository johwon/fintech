package com.zerobase.com.zerobase.css.service

import com.zerobase.com.zerobase.css.dto.LoanRequestDto
import com.zerobase.com.zerobase.css.dto.LoanResultDto
import org.springframework.stereotype.Service

@Service
class LoanReviewService {
    fun loanReview(loanRequestDto: LoanRequestDto.RequestInputDto): LoanResultDto.ResponseDto {
        if (loanRequestDto.userIncomeAmount < 0) throw RuntimeException("Invalid userIncomeAmount")
        ...
        throw RuntimeException("Invalid userIncomeAmount")
    }
}