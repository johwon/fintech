...
import com.zerobase.api.com.zerobase.api.loan.request.LoanRequestController
import com.zerobase.api.com.zerobase.api.loan.request.LoanRequestDto
import com.zerobase.api.com.zerobase.api.loan.request.LoanRequestService
import com.zerobase.api.com.zerobase.api.loan.request.LoanRequestServiceImpl
...
internal class LoanRequestControllerTest {
    ...
    private lateinit var generatedKey: GeneratedKey
    ...
    fun testNormalCase() {
        ...
        val loanRequestInfoDto: LoanRequestDto.LoanRequestInputDto =
            LoanRequestDto.LoanRequestInputDto(
                ...
                userRegistrationNumber = "1234-1234"
            )
